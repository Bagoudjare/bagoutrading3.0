...
export const VideoPresentationSection = () => {
  ...
  return (
    <section className="relative py-20 px-4 bg-gradient-to-b from-white via-slate-50 to-white overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-1/4 w-72 h-72 bg-blue-200/30 rounded-full blur-3xl" />
        <div className="absolute bottom-20 right-1/4 w-72 h-72 bg-purple-200/30 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="text-center mb-14">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 mb-6 leading-tight">
            Gagnez sur les marchés est une{" "}
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              compétence
            </span>
          </h2>
          <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Et BMAE vous aide à développer cette compétence étape par étape. Découvrez comment notre outil analyse le marché en temps réel et vous guide vers des décisions de trading plus disciplinées.
          </p>
        </div>

        {/* Video Container */}
        <div className="relative max-w-5xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-slate-900/20 border border-slate-200 bg-slate-900 group cursor-pointer"
            ...
            <div className="relative aspect-video">
              ...
              {/* YouTube badge */}
              <div className="absolute bottom-4 right-4 bg-black/80 backdrop-blur text-white text-sm px-3 py-2 rounded-lg flex items-center gap-2">
            ...
            {/* Floating badges */}
            <div className="absolute top-6 left-6 bg-white/95 backdrop-blur text-slate-900 text-sm font-semibold px-4 py-2 rounded-full shadow-lg flex items-center gap-2 animate-fade-in">
              <CheckCircle2 className="h-4 w-4 text-green-500" />
              Analyse temps réel
            </div>

            <div className="absolute top-6 right-6 bg-white/95 backdrop-blur text-slate-900 text-sm font-semibold px-4 py-2 rounded-full shadow-lg flex items-center gap-2 animate-fade-in">
