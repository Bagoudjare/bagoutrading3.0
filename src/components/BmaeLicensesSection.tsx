...
export const BmaeLicensesSection = () => {
  return (
    <div id="licence" className="py-20 px-4 bg-gradient-to-br from-slate-800 to-slate-900">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-14">
          <span className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider bg-purple-500/20 text-purple-300 border border-purple-500/30 mb-4">
            Offres de lancement
          </span>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Standard 6 mois */}
          <div className="relative bg-gradient-to-br from-slate-700/60 to-slate-800/60 rounded-2xl p-8 border border-slate-600/40 backdrop-blur-sm">
            ...
            <div className="mb-6">
              <div className="flex items-baseline gap-3">
                ...
                <span className="text-lg text-gray-500 line-through">699,99 $</span>
              </div>
              <p className="text-xs text-blue-300 mt-1">Tarif de lancement</p>
            </div>
          ...
          {/* Lifetime */}
          <div className="relative bg-gradient-to-br from-purple-900/50 to-blue-900/50 rounded-2xl p-8 border-2 border-purple-500/50 backdrop-blur-sm shadow-2xl shadow-purple-500/20">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs font-bold px-4 py-1 rounded-full uppercase tracking-wider">
              Recommandée
            </div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-xl bg-purple-500/30 border border-purple-500/50 flex items-center justify-center">
            ...
            <div className="mb-6">
              <div className="flex items-baseline gap-3">
                ...
                <span className="text-lg text-gray-500 line-through">1 999,99 $</span>
              </div>
              <p className="text-xs text-purple-300 mt-1">Tarif de lancement</p>
            </div>
            <ul className="space-y-3 mb-8">
              {benefitsLife.map((b) => (
