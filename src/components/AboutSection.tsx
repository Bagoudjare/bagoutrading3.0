          ...
          <div className="relative">
            <div className="bg-slate-900/40 p-8 rounded-xl border border-slate-800/80 backdrop-blur-md shadow-md">
              <div className="text-center mb-6">
                <div className="w-48 h-60 bg-gradient-to-br from-blue-500 to-purple-500 rounded-2xl mx-auto mb-4 flex items-center justify-center overflow-hidden shadow-lg border border-slate-700/50">
