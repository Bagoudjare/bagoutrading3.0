...
export const ContactSection = () => {
  ...
  const socialLinks = [
    { name: "Facebook", icon: FacebookIcon, url: "https://web.facebook.com/bagoudjare228", color: "from-blue-600 to-blue-800" },
    // { name: "Telegram", icon: TelegramIcon, url: "https://t.me/+enH3ARAoOoxlOTk0", color: "from-blue-400 to-blue-600" },
    { name: "WhatsApp", icon: WhatsAppIcon, url: "https://whatsapp.com/channel/0029Vb6533j2Jl8BFdEVFd0C", color: "from-green-400 to-green-600" },
    { name: "YouTube", icon: YouTubeIcon, url: "https://www.youtube.com/@bt3.0trading", color: "from-red-400 to-red-600" },
    { name: "Instagram", icon: InstagramIcon, url: "https://www.instagram.com/bagoudjaretrading?igsh=MXVqemU0MTVhM2w1dA==", color: "from-fuchsia-500 to-purple-600" }
