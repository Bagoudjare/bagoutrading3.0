...
export const ContactSection = () => {
  ...
  const socialLinks = [
    { name: "Facebook", icon: FacebookIcon, url: "#", color: "from-blue-600 to-blue-800" },
    { name: "Telegram", icon: TelegramIcon, url: "#", color: "from-blue-400 to-blue-600" },
    { name: "WhatsApp", icon: WhatsAppIcon, url: "#", color: "from-green-400 to-green-600" },
    { name: "YouTube", icon: YouTubeIcon, url: "#", color: "from-red-400 to-red-600" }
  ];
