  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      <Helmet>
        ...
        <meta property="og:title" content="Inscription Programme Partenaire SEI" />
        <meta property="og:description" content="Formulaire d'inscription gratuit pour devenir partenaire SEI." />
      ...
      <main className="max-w-4xl mx-auto px-4 py-20">
        <header className="text-center mb-12">
          <Link to="/partenaire-avantages" className="text-blue-300 hover:text-blue-200 text-sm uppercase tracking-widest mb-4 inline-block transition-colors">
            ← Voir les avantages
          </Link>
