...
const lessons: Lesson[] = [
  ...
  {
    number: 2,
    title: "Termes et principes du forex",
    description: "Apprenez à comprendre les termes et les principe utiliser dans le monde du forex.",
    duration: "5:14",
    videoId: "xubKsjihhnc",
  },
  {
    number: 3,
    title: "Commment trader sur le marché du forex",
    description: "comprenez quels sont les moments propice pour trader, et ce qu'il faut trader.",
    duration: "2:32",
    videoId: "b0F13fSlOr0",
  },
  {
    number: 4,
    title: "Quest ce qu'un brockers",
    description: "comprenez ce qu'est un Broker et les types de brockers.",
    duration: "3:29",
    videoId: "zDnWlPpqyKg",
  },
  {
    ...
    description: "Comprendre l'analyse fondamentale et et outils a utiliser pour faire cette analyse.",
    duration: "4:48",
    videoId: "AVMBEhH-16o",
  },
  {
    ...
    description: "Demonstration en temps réel de l'analyse fondamental sur le marché du Forex.",
    duration: "7:06",
    videoId: "86vWm8LePRs",
  },
  {
    number: 7,
    title: "Les Bases de l'Analyse graphique",
    description: "Comprendre l'analyse fondamentale l'analyse graphique .",
    duration: "3:47",
    videoId: "TBTRV1otTo4",
  },
//   {
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full text-left bg-slate-900/40 hover:bg-slate-900/60 backdrop-blur-md rounded-xl p-6 border border-slate-800/80 hover:border-blue-500/30 hover:transform hover:scale-[1.01] transition-all duration-300 group"
                    >
